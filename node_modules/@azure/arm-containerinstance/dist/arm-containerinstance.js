...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ContainerGroups = /** @class */ (function () {
         ...
         * @returns Promise<msRest.RestResponse>
         */
        ContainerGroups.prototype.start = function (resourceGroupName$$1, containerGroupName$$1, options) {
            return this.beginStart(resourceGroupName$$1, containerGroupName$$1, options)
                .then(function (lroPoller) { return lroPoller.pollUntilFinished(); });
        };
        /**
         * Create or update container groups with specified configurations.
         ...
         * @returns Promise<msRestAzure.LROPoller>
         */
        ContainerGroups.prototype.beginStart = function (resourceGroupName$$1, containerGroupName$$1, options) {
            return this.client.sendLRORequest({
                resourceGroupName: resourceGroupName$$1,
                containerGroupName: containerGroupName$$1,
                options: options
